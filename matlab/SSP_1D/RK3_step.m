function unew = RK3_step(fcn, t, u, h)
% usage: unew = RK3_step(fcn, t, u, h)
%
% Runge-Kutta method of order 3 for one step of the scalar-valued
% ODE problem, 
%     y' = f(t,y), t in tspan,
%     y(t0) = y0.
%
