...
int main() {
  ...
  for(int ii = 0; ii < CFLS2.size(); ii++){
      ...
      char fname[35];
      sprintf(fname,"ycalc_NonlinearL_erk2_CFL(%g).txt",CFL);
      ycal.Write(fname);
    }
    ...
    for(int ii = 0; ii < CFLS2.size(); ii++){
      ...
      char fname[35];
      sprintf(fname,"ycalc_NonlinearL_ssp2_CFL(%g).txt",CFL);
      ycal.Write(fname);
    }
    ...
    for(int ii = 0; ii < CFLS3.size(); ii++){
      ...
      char fname[35];
      sprintf(fname,"ycalc_NonlinearL_erk3_CFL(%g).txt",CFL);
      ycal.Write(fname);
    }
    ...
    char fname[35];
    sprintf(fname,"ycalc_NonlinearL_ssp3_CFL(%g).txt",CFL);
    ycal.Write(fname);
  ...
  for(int ii = 0; ii < CFLS4.size(); ii++){
      ...
      for (int istep=0; istep<Nt; istep++) {
       ...
       char fname[35];
       sprintf(fname,"ycalc_NonlinearL_erk4_CFL(%g).txt",CFL);
       ycal.Write(fname);
    }
    ...
    char fname[35];
    sprintf(fname,"ycalc_NonlinearL_ssp4_CFL(%g).txt",CFL);
    ycal.Write(fname);
