...
std::vector<double> circshift(std::vector<double> myvector, int shift){
  if(shift < 0) 
    std::rotate(myvector.begin(),myvector.begin() - shift ,myvector.end());
  else
    std::rotate(myvector.rbegin(),myvector.rbegin() + shift ,myvector.rend());
